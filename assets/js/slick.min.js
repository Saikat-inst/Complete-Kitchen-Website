...
! function(i) {
    ...
    s = 0, (r = function(i, e) {
        ...
        o.defaults = {
            ...
            arrows: !0,
            asNavFor: null,
            prevArrow: '<button class="slick-prev" aria-label="Previous" type="button"><i class="architect-icons-ios-arrow-back"</i></button>',
            nextArrow: '<button class="slick-next" aria-label="Next" type="button"><i class="architect-icons-ios-arrow-forward"</i></button>',
            autoplay: !1,
            autoplaySpeed: 3e3,
            centerMode: !1,
            centerPadding: "50px",
